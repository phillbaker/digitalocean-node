(function() {
  ...
  var Volume = (function() {
     ...
     *
     * @param {string} id - The id or name/region object of the volume to
     *   retrieve
     * @param {requestCallback} [callback] - callback that handles the response
     * @memberof Volume
     */
    Volume.prototype.get = function(parametersOrId, callback) {
      var url = 'volumes';
      var parameters = {};
      if (typeof(parametersOrId) === 'string') {
        url = util.safeUrl('volumes', id);
      } else {
        parameters = parametersOrId;
      }
      return this.client.get(url, parameters, 200, 'volume', callback);
    };
     ...
     *
     * @param {string|object} parametersOrId - The id or or name/region object
     *   of the volume to delete.
     * @param {requestCallback} [callback] - callback that handles the response
     * @memberof Volume
     */
    Volume.prototype.delete = function(parametersOrId, callback) {
      var url = 'volumes';
      var parameters = {};
      if (typeof(parametersOrId) === 'string') {
        url = util.safeUrl('volumes', parametersOrId);
      } else {
        parameters = parametersOrId;
      }
